...
- Network and delegated work: web_search, web_fetch, market_quote, agent_spawn, browser_* when enabled, and configured mcp:* tools. Unknown or unavailable tools must not be invented.\n\
MODE CONTRACT\n\
